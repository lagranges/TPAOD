...
do
    ...
    test1=$((test1)) #on supprime les zeros en tete
    ...
    test2=$((test2)) #on supprime les zeros en tete
    ...
    test3=$((test3)) #on supprime les zeros en tete
    ...
    test4=$((test4)) #on supprime les zeros en tete
    ...
    test5=$((test5)) #on supprime les zeros en tete
    test5+="0" #on convertit en millisecondes

    moy=$(echo $test1 + $test2 + $test3 + $test4 + $test5 | bc)
    moy=$(($moy/5))
